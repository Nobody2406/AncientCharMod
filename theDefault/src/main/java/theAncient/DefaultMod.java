...
import theAncient.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String AUTHOR = "Nobody"; // And pretty soon - You!
    private static final String DESCRIPTION = "A base for Slay the Spire to start your own mod from, feat. the Ancient.";
    
    // =============== INPUT TEXTURE LOCATION =================
    
    // Colors (RGB)
    // Character Color
    public static final Color ANCIENT_YELLOW = CardHelper.getColor(250, 200, 75);
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theAncientResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theAncientResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theAncientResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "theAncientResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theAncientResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theAncientResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theAncientResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theAncientResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theAncientResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theAncientResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theAncientResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theAncientResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theAncientResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theAncientResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theAncientResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theAncientResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theAncientResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        logger.info("Creating the color " + TheAncient.Enums.COLOR_ANCIENT_YELLOW.toString());
        
        BaseMod.addColor(TheAncient.Enums.COLOR_ANCIENT_YELLOW, ANCIENT_YELLOW,
    ...
    public void receiveEditCharacters() {
        logger.info("Beginning to edit characters. " + "Add " + TheAncient.Enums.THE_ANCIENT.toString());
        
        BaseMod.addCharacter(new TheAncient("the Ancient", TheAncient.Enums.THE_ANCIENT),
                THE_DEFAULT_BUTTON, THE_DEFAULT_PORTRAIT, TheAncient.Enums.THE_ANCIENT);
        
        receiveEditPotions();
        logger.info("Added " + TheAncient.Enums.THE_ANCIENT.toString());
    }
    ...
    public void receivePostInitialize() {
        ...
        AddEventParams eventParams = new AddEventParams.Builder(IdentityCrisisEvent.ID, IdentityCrisisEvent.class) // for this specific event
            ...
            .playerClass(TheAncient.Enums.THE_ANCIENT) // Character specific event
            .create();
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(PlaceholderPotion.class, PLACEHOLDER_POTION_LIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, PlaceholderPotion.POTION_ID, TheAncient.Enums.THE_ANCIENT);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("theAncient") // ${project.artifactId}
