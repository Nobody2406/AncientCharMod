...
public class PrestigePower<amount> extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID("PrestigePower");
    ...
    static final int MULTIPLIER = -1;

    public PrestigePower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void atStartOfTurnPostDraw() {
        ...
        @Override
        public void update() {
            if (PrestigePower.this.amount >= DIVISOR) {
                PrestigePower.this.flash();
                this.addToBot(new ApplyPowerAction(AbstractDungeon.player, (AbstractCreature) null, new MantraPower(AbstractDungeon.player, PrestigePower.this.amount / DIVISOR), PrestigePower.this.amount / DIVISOR));
            }
            this.isDone = true;
        }
    });
